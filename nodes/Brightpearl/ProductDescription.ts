	...
	},
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Filter by brand ID. ID set syntax supported.',
			},
			{
				displayName: 'Category Code',
				name: 'brightpearlCategoryCode',
				type: 'string',
				default: '',
				description:
					'Filter by Brightpearl category code. ID set syntax supported (e.g. 100, 100-200, 100,150).',
			},
			{
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Filter by exact MPN (manufacturer part number)',
			},
			{
				...
				default: '',
				description:
					'Filter to products whose primary supplier matches a contact ID. ID set syntax supported.',
			},
			{
				...
				type: 'number',
				default: 0,
				description: 'Filter by the parent product group ID (for variation products)',
			},
			{
				displayName: 'Product ID',
				name: 'productId',
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Filter by product type ID. ID set syntax supported.',
			},
			{
				displayName: 'Sales Channel Name',
				name: 'salesChannelName',
				type: 'string',
				default: '',
				description: 'Filter by sales channel name',
			},
			{
				displayName: 'SKU',
				name: 'SKU',
			...
			},
			{
				...
				default: true,
				description:
					'Whether to include only stock-tracked or only non-stock-tracked products',
			},
			{
				displayName: 'UPC',
				name: 'UPC',
